...
The `LogLevel` enum class is a crucial component of the `loggingpython` package, providing a simple and extensible way to integrate logging into Python applications. This documentation offers a detailed insight into the functionality and usage of the `LogLevel` enum class defined in this file.
...
The following sections automatically generate documentation for the `LogLevel` class and its members within the `loggingpython` module.
...
.. autoclass:: loggingpython.LogLevel
   :members:
   :undoc-members:
   :show-inheritance:
   :no-index:
